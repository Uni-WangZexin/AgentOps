...
按综述的分类与叙述建立交叉索引。**同一文献可以出现在多个相关类别**，因为异常类别、检测方法和运维阶段是不同维度。
...
| 类型 | 条目 | 说明 | 原文编号 |
| --- | --- | --- | --- |
| model_card | [The claude 3 model family: opus, sonnet, haiku. claude-3 model card](https://www.anthropic.com/news/claude-3-family) | Claude 3 系列的厂商资料，提供模型能力与局限的背景；属于模型卡/官方材料，不是异常检测算法论文。 | [2](../docs/references.md#ref-2) |
| tool_documentation | [Ai-infra-guard](https://github.com/Tencent/AI-Infra-Guard) | 腾讯 AI-Infra-Guard 是安全扫描工具；综述特别引用其 MCP 风险检查能力，不将项目文档当作同行评议论文。 | [22](../docs/references.md#ref-22) |
| blog | [Emergent behavior in multi-agent systems: how complex behaviors arise from simple agent interactions](https://medium.com/@sanjeevseengh/emergent-behavior-in-multi-agent-systems-how-complex-behaviors-arise-from-simple-agent-0e4503b376ce) | 介绍局部交互如何产生宏观涌现行为；是概念性博客，用作协作风险背景，不构成受控实验结论。 | [29](../docs/references.md#ref-29) |
| blog | [Building high-quality ai agent systems: best practices](https://www.pondhouse-data.com/blog/high-quality-ai-agent-systems) | 讨论智能体系统的工程实践与质量管理；属于经验性文章，综述用于说明任务定义和系统设计问题。 | [35](../docs/references.md#ref-35) |
| blog | [Real-time anomaly detection for multi-agent ai systems](https://galileo.ai/blog/real-time-anomaly-detection-multi-agent-ai) | Galileo 的工程文章讨论多智能体实时异常监控；其工具建议与经验应和学术实验结果区分。 | [40](../docs/references.md#ref-40) |
| whitepaper | [Taxonomy of failure mode in agentic ai systems](https://www.microsoft.com/en-us/security/blog/2025/04/24/new-whitepaper-outlines-the-taxonomy-of-failure-modes-in-ai-agents/) | 微软白皮书给出智能体失效模式分类，作为工业界故障视角的补充；与本综述的八类异常不应一一强行对应。 | [42](../docs/references.md#ref-42) |
| tool_documentation | [What is agentic operations (agenticops)?](https://www.cisco.com/site/us/en/learn/topics/artificial-intelligence/what-is-agentic-operations-agenticops.html) | Cisco 对 AgenticOps 的官方介绍侧重智能体参与运维；可用于比较概念，不能直接代替本综述的 AgentOps 定义。 | [49](../docs/references.md#ref-49) |
| tool_documentation | [OpenTelemetry: a cloud native observability framework](https://opentelemetry.io) | OpenTelemetry 提供通用遥测规范和采集基础，是统一 trace、span、指标与日志的重要基础设施。 | [50](../docs/references.md#ref-50) |
| tool_documentation | [LangDB: llm‑enhanced database exploration](https://github.com/langdb/ai-gateway) | 原文将 LangDB 列为监控工具；所引仓库现重定向至 vLLora，阅读时需区分论文记录名称与项目现状。 | [54](../docs/references.md#ref-54) |
| tool_documentation | [Langfuse: open‑source llm tracing and observability](https://github.com/langfuse/langfuse) | Langfuse 提供 LLM 应用追踪与评测能力，是原文监控工具表中的开源平台条目。 | [55](../docs/references.md#ref-55) |
| tool_documentation | [MLflow for GenAI: Build Production‑Ready AI Applications](https://mlflow.org/genai) | MLflow 的 GenAI 材料介绍生成式 AI 应用的追踪、评测和工程管理，是平台资料而非检测方法论文。 | [56](../docs/references.md#ref-56) |
| tool_documentation | [Helicone: llm observability platform](https://github.com/Helicone/helicone) | Helicone 记录 LLM 请求与运行指标，支持检查调用成本、延迟和输出等可观测信息。 | [57](../docs/references.md#ref-57) |
| tool_documentation | [LangWatch](https://github.com/langwatch) | LangWatch 是原文监控工具目录中的项目；提供的链接指向组织主页，具体能力应以所使用版本文档为准。 | [58](../docs/references.md#ref-58) |
| tool_documentation | [LlamaTrace — hosted phoenix: llm tracing & evaluation platform](https://phoenix.arize.com/llamatrace/) | LlamaTrace 是基于 Phoenix 的托管追踪与评测入口；与 [61] 的 Phoenix 有关联，不宜简单计为完全独立技术栈。 | [59](../docs/references.md#ref-59) |
| tool_documentation | [OpenLLMetry: open‑source observability for your llm application](https://github.com/traceloop/openllmetry) | OpenLLMetry 基于 OpenTelemetry 对 LLM 应用插桩，为跨组件追踪提供工程基础。 | [60](../docs/references.md#ref-60) |
| tool_documentation | [Arize phoenix: open‑source llm tracing & evaluation platform](https://phoenix.arize.com/) | Arize Phoenix 提供开源追踪与评测能力，原文用其说明现有 LLM 可观测性工具。 | [61](../docs/references.md#ref-61) |
| tool_documentation | [Literal ai: rag llm evaluation & observability platform](https://www.literalai.com/) | Literal AI 提供 LLM/RAG 应用的评测和可观测性工具；本目录保留原文所引官网并记录访问核验限制。 | [62](../docs/references.md#ref-62) |
| tool_documentation | [Opik — open‑source llm evaluation platform](https://www.comet.com/site/products/opik/) | Opik 是用于 LLM/智能体应用追踪与评测的平台，帮助把执行记录与质量评估结合。 | [63](../docs/references.md#ref-63) |
| tool_documentation | [OpenInference: opentelemetry instrumentation for ai observability](https://github.com/Arize-ai/openinference) | OpenInference 提供面向 AI 可观测性的 OpenTelemetry 插桩和语义约定，是采集层组件而非终端诊断模型。 | [64](../docs/references.md#ref-64) |
| tool_documentation | [TruLens: open‑source llm evaluation & observability platform](https://www.trulens.org/) | TruLens 为 LLM 应用提供追踪与评估工具，支持把过程记录和质量反馈联系起来。 | [65](../docs/references.md#ref-65) |
| tool_documentation | [HoneyHive: ai observability and evaluation platform](https://www.honeyhive.ai/) | HoneyHive 是原文收录的智能体可观测性与评估平台，属于工程产品资料。 | [66](../docs/references.md#ref-66) |
| tool_documentation | [PromptLayer: platform for prompt engineering, management, evaluation, and llm observability](https://www.promptlayer.com/) | PromptLayer 将提示词管理、实验、评估和调用追踪结合，覆盖提示版本变化带来的质量管理需求。 | [67](../docs/references.md#ref-67) |
| tool_documentation | [AgentOps: developer platform for ai agent observability](https://www.agentops.ai/) | AgentOps.ai 是面向智能体可观测性的开发平台；产品名称不等于整个 AgentOps 研究领域。 | [68](../docs/references.md#ref-68) |
| tool_documentation | [DeepEval: the llm evaluation framework](https://github.com/confident-ai/deepeval) | DeepEval 是 LLM 应用评测框架，提供质量检查工具；评测指标不能自动替代因果诊断。 | [69](../docs/references.md#ref-69) |
| tool_documentation | [LangSmith: The Agent Engineering Platform](https://www.langchain.com/langsmith-platform) | LangSmith 是智能体工程平台，原文将其作为追踪、调试和评测工具的例子。 | [70](../docs/references.md#ref-70) |
| tool_documentation | [LangGraph: persistence and time travel](https://docs.langchain.com/oss/python/langgraph/persistence) | LangGraph 的持久化与时间旅行文档介绍检查点、恢复和分叉执行，为回滚重执行提供工程实现参考。 | [111](../docs/references.md#ref-111) |
